@extends('layouts.app')
    ...
    @section('js')
        ...
        {!! Html::script('js/modulos/titulares/bitacoras.js'); !!}
                        ...
                        <div class="form-group row" id="vadjunto">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    {!! Form::file('files', ['id'=>'filer', 'class'=>'form-control']); !!}
                                </div>
                        ...
                        <div class="form-group row" id="vcodigo_clasificacion">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    {!! Form::text('codigo_clasificacion', null, ['id' => 'codigo_clasificacion', 'placeholder'=>'Codigo de Clasificacion', 'class' =>  'form-control']) !!}
                                </div>
                                <label id="el-numero" class="error hidden" for="numero"></label>
                            </div>
                        </div>
