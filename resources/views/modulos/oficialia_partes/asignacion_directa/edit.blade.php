...
@section('content')
    ...
    {{ Form::model($datos, array('route' => 'oop.asignacion-directa.store', 'method' => 'POST' , 'files' => true, 'id' => 'myform', 'name'=>'myform', 'class' => 'form-horizontal myform',  'enctype'=>'multipart/form-data', 'accept-charset'=>'UTF-8' ), array('role' => 'form')) }}
        {!! Form::hidden('id', null, ['id'=>'id']) !!}                  
        @include('modulos.oficialia_partes.asignacion_directa.form')
    {!! Form::close() !!}
@endsection
