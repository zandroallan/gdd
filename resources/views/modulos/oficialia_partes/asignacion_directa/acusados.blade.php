...
@section('scripts')  
    dt_default3('{{ URL::route('oop.asignacion-directa.resultados',2) }}', '{{ URL::route($current_route.'.edit','_') }}');  
        ...
        <div class="panel-body">
            ...
            <table class="dt_default table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th width="10px">#</th>
                        <th width="150px">Núm. documento</th>
                        <th>Dependencia/Organismo</th>
                        <th>Destinatario</th>
                        <th width="150px" align="center">Fecha del documento</th>
                        <th width="150px" align="center">Fecha de envío</th>
                        <th width="150px" align="center">Acuse</th>                        
                    </tr>
                </thead>
                <tbody id='dt_default'>
                </tbody>
