...
@section('content')
    {!! Form::open(['route' => 'oop.asignacion-directa.store', 'method' => 'POST' , 'files' => true, 'id' => 'myform', 'name'=>'myform', 'class' => 'form-horizontal myform', 'enctype'=>'multipart/form-data', 'accept-charset'=>'UTF-8'], ['role' => 'form']) !!}        
