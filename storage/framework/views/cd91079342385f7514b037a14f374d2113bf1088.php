    ...
    <?php $__env->startSection('js'); ?>
        ...
        <?php echo Html::script('js/modulos/titulares/enviados.js');; ?>
                            ...
                            <ul class="mailbox-list">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#tab-3" id="btn_3">
                                        <i class="fa fa-institution text-warning"></i> Folios
                                    </a>
                                </li>
                                <?php endif; ?>
                                <?php if(Auth::User()->id_area != 4): ?>
                        ...
                        <div class="tab-content ">
                            ...
                            <div id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive project-list vrespuesta2">                                        
                                        <table class="table table-hover table-mailbox" data-sorting="true" data-filtering="true" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr class="csstr">
                                                    <th class="text-center">No</th>
                            ...
                            <div id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <h3><i class="fa fa-institution text-warning"></i> Folios</h3>
