    <?php $__env->startSection('css'); ?>
    	...
    	<?php echo Html::style('template/vendor/summernote/dist/summernote.css');; ?> 
        <?php echo Html::style('template/vendor/summernote/dist/summernote-bs3.css');; ?> 
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php echo Form::open(['route' => ['anexos.destroy', 0], 'id'=>'myformdeleteanexo', 'name'=>'myformdeleteanexo','method' => 'DELETE' , 'class' => 'myformdeleteanexo', 'style'=>'display : inline;'], ['role' => 'form']); ?>

        <?php echo Form::close(); ?>


        <?php echo Form::model($respuesta, array('route'=>$current_route.'.store', 'method'=>'POST', 'files'=>true, 'name'=>'myform', 'id' => 'frm-draft', 'class'=>'form-horizontal myform', 'enctype'=>'multipart/form-data'), array('role'=>'form')); ?>
    ...
    <?php $__env->startSection('js'); ?>
        ...
        <?php echo $__env->make('tools.sign_js', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
        <?php echo Html::script('template/vendor/summernote/dist/summernote.min.js');; ?>
        ...
        <?php echo Html::script('js/anexos.js');; ?>  
        <?php echo Html::script('js/modulos/titulares/borradores.create.js');; ?>  
