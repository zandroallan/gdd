...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            button: "Examinar...",
            feedback: "Elegir documentos para subir",
            feedback2: "documento(s) elegido(s)",
            drop: "Drop file here to Upload",
            removeConfirmation: "Estas seguro de eliminar el documento?",
            errors: {
                filesLimit: "Solamente archivos {{fi-limit}} son permitidos.",
                filesType: "Solo imagenes son permitidas.",
                filesSize: "{{fi-name}} es muy grande! Tamaño máximo: {{fi-fileMaxSize}} MB.",
                filesSizeAll: "Los archivos elegidos son muy grandes! Tamaño máximo: {{fi-maxSize}} MB.",
